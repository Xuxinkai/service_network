...
<!-- 这个是显示m-a-t的异构网络图   -->
<div id="matcontainer" style="height: 700px;width: 100%;"></div>
...
var dom = document.getElementById("matcontainer");
var myChart = echarts.init(dom);
var app = {};
option = null;
myChart.showLoading();
$.getJSON('MashupApiTagRelationToJson', function (webkitDep) {
    myChart.hideLoading();
...
function filedown(){
	var url="AnalyzeDataDownLoad?fileName=mashup-api-tag.txt";
