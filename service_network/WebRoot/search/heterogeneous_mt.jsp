...
<!-- 这个是显示m-t的异构网络图   -->
<div id="mtcontainer" style="height: 700px;width: 100%;"></div>
...
function filedown(){
	var url="AnalyzeDataDownLoad?fileName=mashup-tag.txt";
	window.location.href=url;
}
var dom = document.getElementById("mtcontainer");
var myChart = echarts.init(dom);
var app = {};
option = null;
myChart.showLoading();
$.getJSON('MashupTagRelationToJson', function (webkitDep) {
    myChart.hideLoading();
