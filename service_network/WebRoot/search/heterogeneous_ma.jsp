...
<!-- 这个是显示m-a的异构网络图   -->
<div id="macontainer" style="height: 700px;width: 100%;"></div>
...
var dom = document.getElementById("macontainer");
var myChart = echarts.init(dom);
var app = {};
option = null;
myChart.showLoading();
$.getJSON('MashupApiRelationToJson', function (webkitDep) {
    myChart.hideLoading();
...
function filedown(){
	var url="AnalyzeDataDownLoad?fileName=mashup-api.txt";
