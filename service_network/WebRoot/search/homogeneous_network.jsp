...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <title>Homogeneous Network-Service Network</title>
    <meta charset="utf-8">
...
<body onload="loadhtml('homogeneous_mashup.jsp')">

<div class="container">

   <%@ include file="header.jsp" %>
	<nav><!-- Define the navigation menu 同构网络 -->
        <ul>
            ...
            <li  class="active"><a href="homogeneous_network.jsp">Homogeneous Network</a></li>
    ...
    <div id="submain"><!-- Define submain content section -->
        <section id="subcontent"><!-- Define the content section #2 -->
            <div id="homogeneousNetworkDIV">
          
            <!-- 显示图 -->
              <div id="contentDiv" style="width: 99.5%;border-color: #e7e7e7;border-style: solid;border-width: 1px;"></div>  
